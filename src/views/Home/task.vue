  ...
  <div class="task">
    <el-tabs :tab-position="tabPosition">
      <el-tab-pane label="我的任务">
        ...
        <el-table :data="tasks" style="width: 100%" size="medium">
          ...
          <el-table-column prop="plan" label="进度" width="150">
          </el-table-column>
          <el-table-column prop="start" label="开始时间" width="160">
          </el-table-column>
          <el-table-column prop="end" label="结束时间" width="160">
          </el-table-column>
          <el-table-column prop="tag" label="标签" width="120" :filters="[{ text: '正常', value: '正常' }, { text: '紧急', value: '紧急' }]" filter-placement="bottom-end">
            <template slot-scope="scope">
              <el-tag :type="scope.row.tag === '正常' ? 'primary' : 'success'" disable-transitions>{{scope.row.tag}}</el-tag>
            </template>
          </el-table-column>
          ...
          <el-table-column label="操作" width="140">
            <template slot-scope="scope">
              ...
              <el-button type="text" size="small" @click="onDone(scope.row)">完成</el-button>
            </template>
          </el-table-column>
        </el-table>
      </el-tab-pane>
...
export default {
  ...
  methods: {
    ...
    onDone (row) {
      console.log(row)
      let index = this.tasks.indexOf(row)
